...
from threeplugpro.commands.bench.handlers import run_bench_create, run_bench_list
...
def register(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    bench_create = bench_sub.add_parser("create", help="Create one managed Bench runtime.")
